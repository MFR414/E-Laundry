        ...
        <section>
            <div>
                <div class="title-block">
                    <h1 class="title">Tambah cabang</h1>
                    <p class='title-description'>Gunakan form dibawah untuk menambahkan cabang baru kedalam aplikasi.</p>
                </div>
            </div>
        </section>
        <br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title-body">
                                <h3 class="title">Tambah cabang</h3>
                            </div>
                            <form action="{{ route('application.tenants.store') }}" method="POST" style="margin-bottom: 0">
                                {{ csrf_field() }}
                                <section>
                                    <div class="row">
