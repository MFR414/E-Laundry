...
<section class="content">
        ...
        <section>
            <div class="d-flex d-flex d-flex justify-content-between">
                ...
                <div class="tambah-admin">
                    <a class="btn btn-primary btn-md" href="{{ route('application.users.super-admins.create' )}}">
                        <i class="fa fa-plus">
                        </i>
                        Tambah super admin
                    </a>
            ...
            <div class="card">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="margin-bottom: 0px !important;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Daftar super admin</li>
                    </ol>
                </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title-body">
                                <h3 class="title">Cari super admin</h3>
                            </div>
                            <form action="{{ route('application.users.super-admins.index') }}" method="GET" style="margin-bottom: 0">
                                <section>
                                    <div class="row">
                ...
                <table class="table table-bordered center" style="overflow-x: auto;">
                    ...
                    <tbody>
                        @if(count($superAdmins) <= 0)
                            <tr>
                                <td colspan="6">Tidak ada data super admin</td>
                            </tr>
                        @else
                            @foreach( $superAdmins as $index => $superAdmin )
                            <tr>
                                <td>
                                    {{$superAdmins->firstItem() + $index}}
                                </td>
                                <td>
                                    {{$superAdmin->username}}
                                </td>
                                ...
                                <td class="project-actions text-right" style="display: flex; gap:5px;">
                                    <a class="btn btn-primary btn-sm" style="padding-top: 8px;" href="{{ route('application.users.super-admins.edit', $superAdmin)}}">
                                        <i class="fa fa-pencil">
                                        </i>
                                        Edit
                                    </a>
                                    <form action="{{ route('application.users.super-admins.destroy', $superAdmin) }}" method="POST" id='deleteForm'>
                                        @csrf
                                        {{ method_field('DELETE') }}
  ...
  <script>
    function confirmDelete() {
        if(confirm("Apakah anda yakin ingin menghapus data super admin ini?")) {
